...
async def main():
    ...
    text2 = "I am here to assist you with anything you need."
    
    # Convert text to speech and play with different voices
    await text_to_speech(text1, voice='en-US-AriaNeural')
    await text_to_speech(text2, voice='en-IN-PrabhatNeural')
